...
books = pd.read_csv('https://github.com/Maxto5/Book-Recommendation-system/Books.csv', dtype='unicode')
users = pd.read_csv('https://github.com/Maxto5/Book-Recommendation-system/Users.csv')
ratings = pd.read_csv('https://github.com/Maxto5/Book-Recommendation-system/Ratings.csv')
